...
# read counts files
con1 = read.csv(file = "./0-RawData/2-CRISPR/lrrc8a.con1.csv")
con1$UID = paste0(con1$UID1, "_", con1$UID2)
rownames(con1) = con1$UID

con2 = read.csv(file = "./0-RawData/2-CRISPR/lrrc8a.con2.csv")
con2$UID = paste0(con2$UID1, "_", con2$UID2)
rownames(con2) = con2$UID

cgamp1 = read.csv(file = "./0-RawData/2-CRISPR/lrrc8a.cgamp1.csv")
cgamp1$UID = paste0(cgamp1$UID1, "_", cgamp1$UID2)
rownames(cgamp1) = cgamp1$UID

cgamp2 = read.csv(file = "./0-RawData/2-CRISPR/lrrc8a.cgamp2.csv")
...
write.csv(de, file = "./2-CRISPR/1-seq-degs-lrrc8a.csv")
...
write.csv(degs, file = "./2-CRISPR/2-gene-degs-lrrc8a.csv")
...
# rank plot
degs = read.csv(file = "./2-CRISPR/2-gene-degs-lrrc8a.csv")
...
kk = c("TMEM173", "IRF3", "TBK1", "LRRC8A", "VCP", "VPS4B")

lab_gene = pdata[kk,]
lab_gene$Discription = c(rep("STING", 4), rep("MY", 2))
...
p1
ggsave(p1, filename = "./2-CRISPR/2-lrrc8a-rank.pdf", width = 3, height = 3.5)
